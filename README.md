...
> Easy context manager for temp directories

[![PyPI version](https://badge.fury.io/py/easy-temp-dir.svg)](https://pypi.org/project/easy-temp-dir/)
...
```bash
pip install easy-temp-dir
```

## Quick Start

```python
from easy_temp_dir import dir

# Basic usage
result = dir("your input here")
print(result)
```
...
result = dir("Hello World")

# Example 2: Batch processing
from easy_temp_dir import batch
